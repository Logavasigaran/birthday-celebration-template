    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Shubha Srii</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Shubha Srii's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>My Beautiful Young Woman💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Logavasigaran 💖</h2>
          <p className="final-subtitle">Love You My Young Beautiful Woman ✨</p>
        </section>
      </div>
